...
{
      if(Application -> MessageBox("Czy na pewno utworzy nowy plik?","PotwierdŸ"
...
{
        if(Application -> MessageBox("Czy na pewno chcesz zamkn¹æ obecny dokument, Wszelkie notatki mog¹ zostaæ utracone", "PotwierdŸ"
